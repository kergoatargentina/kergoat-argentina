...
export default function HomePage() {
  return (
    <PublicLayout>
      {/* Hero */}
      <section className="bg-background min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <AnimateOnScroll key={title} direction="up" delay={delay}>
                <div className="bg-pure-white p-10 rounded-2xl border border-deep-navy/10 hover:border-systemic-orange/30 transition-all hover:-translate-y-1 h-full">
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 items-center">
          ...
          <AnimateOnScroll direction="right" className="lg:w-1/2">
            <div className="bg-deep-navy rounded-3xl p-10 text-pure-white">
              ...
              <div className="mt-8 grid grid-cols-2 gap-6 border-t border-white/10 pt-8">
                <div>
                  <div className="text-3xl font-bold text-systemic-orange">
      ...
      {/* CTA final */}
      <section className="py-24 bg-soft-apricot overflow-hidden">
        <AnimateOnScroll direction="up">
